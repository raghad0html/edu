...
import 'package:test/core/services/SearchService.dart';
import 'package:test/views/screens/search_result_page.dart';
import 'package:test/views/widgets/popular_search_card.dart';
import 'package:test/views/widgets/search_history_tile.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  List<Product> listPopularSearch = ProductService.productData;
  @override
          ...
          Column(
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemCount: listPopularSearch.length,
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => SearchResultPage(
                            searchKeyword: listPopularSearch[index].name,
                          ),
                        ),
                      );
                    },
